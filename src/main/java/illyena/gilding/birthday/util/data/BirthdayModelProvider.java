...
import illyena.gilding.birthday.block.TeleportAnchorBlock;
...
public class BirthdayModelProvider extends FabricModelProvider {
    ...
    public BirthdayModelProvider(FabricDataGenerator dataGenerator) {
        super(dataGenerator);
    }
...
//        registerStarPortal(blockStateModelGenerator, BirthdayBlocks.BLACK_STAR_PORTAL_BLOCK);
    ...
    public static void registerStarPortal(BlockStateModelGenerator modelGenerator, Block block) {
        ...
        Identifier blockModelId = block != BirthdayBlocks.STAR_PORTAL_BLOCK ? new Identifier("minecraft", "block/" + color + "_shulker_box") : new Identifier("minecraft", "block/shulker_box");
        Identifier itemModelId = block != BirthdayBlocks.STAR_PORTAL_BLOCK ? new Identifier("minecraft", "entity/shulker/shulker_" + color) : new Identifier("minecraft", "entity/shulker/shulker");
