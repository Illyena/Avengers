...
public class BirthdayBlockTagGenerator extends FabricTagProvider<Block> {
    ...
    protected void generateTags() {
        ...
        getOrCreateTagBuilder(DRAGON_IMMUNE).add(BirthdayBlocks.TELEPORT_ANCHOR);
        getOrCreateTagBuilder(WITHER_IMMUNE).add(BirthdayBlocks.TELEPORT_ANCHOR);
        getOrCreateTagBuilder(PORTALS);
        getOrCreateTagBuilder(SHULKER_BOXES);
        getOrCreateTagBuilder(HOGLIN_REPELLENTS).add(BirthdayBlocks.TELEPORT_ANCHOR);
        getOrCreateTagBuilder(GUARDED_BY_PIGLINS);
        getOrCreateTagBuilder(OCCLUDES_VIBRATION_SIGNALS);
        getOrCreateTagBuilder(FEATURES_CANNOT_REPLACE).add(BirthdayBlocks.TELEPORT_ANCHOR);
        getOrCreateTagBuilder(GEODE_INVALID_BLOCKS).add(BirthdayBlocks.TELEPORT_ANCHOR);
