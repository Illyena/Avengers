...
public class BirthdayLootTableProvider extends SimpleFabricLootTableProvider {
    public static Map<Block, LootTableTypes> lootTables = new HashMap<>();

    public BirthdayLootTableProvider(FabricDataGenerator dataGenerator) { super(dataGenerator, LootContextTypes.BLOCK); }
