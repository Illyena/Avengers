...
public class GildingBlockTagGenerator extends FabricTagProvider<Block> {
    ...
    public static final TagKey<Block> NEEDS_TOOL_LEVEL_5    = TagKey.of(Registry.BLOCK_KEY, new Identifier("fabric", "needs_tool_level_5"));

    public static final TagKey<Block> DRAGON_IMMUNE                 = TagKey.of(Registry.BLOCK_KEY, new Identifier(SUPER_MOD_ID, "dragon_immune"));
    public static final TagKey<Block> WITHER_IMMUNE                 = TagKey.of(Registry.BLOCK_KEY, new Identifier(SUPER_MOD_ID, "wither_immune"));
    public static final TagKey<Block> PORTALS                       = TagKey.of(Registry.BLOCK_KEY, new Identifier(SUPER_MOD_ID, "portals"));
    public static final TagKey<Block> SHULKER_BOXES                 = TagKey.of(Registry.BLOCK_KEY, new Identifier(SUPER_MOD_ID, "shulker_boxes"));
