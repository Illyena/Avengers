...
public class AvengersBlockEntities {
    ...
    public static final BlockEntityType<MjolnirBlockEntity> MJOLNIR_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(MOD_ID, "mjolnir_block_enity"),
