...
public class MjolnirBlock extends BlockWithEntity implements LandingBlock, LimitedFallingBlock, Waterloggable {
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        return this.getDefaultState().with(LEGACY, MJOLNIR_LEGACY.getValue()).with(FACING, context.getPlayerFacing()).with(Properties.WATERLOGGED, fluidState.getFluid() == Fluids.WATER);
    }
