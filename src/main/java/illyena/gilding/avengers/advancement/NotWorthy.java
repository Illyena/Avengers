...
public class NotWorthy extends AbstractCriterion<NotWorthy.Conditions> {
    ...
    protected Conditions conditionsFromJson(JsonObject obj, EntityPredicate.Extended player, AdvancementEntityPredicateDeserializer predicateDeserializer) {
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended player, ItemPredicate itemPredicate, DistancePredicate distancePredicate) {
            super(ID, player);
