...
public class AvengersBlockTagGenerator extends FabricTagProvider<Block> {
    public static final TagKey<Block> MAGIC_MINEABLE        = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "mineable/magic"));
    public static final TagKey<Block> NEEDS_TOOL_LEVEL_5    = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "needs_tool_level_5"));

    public static final TagKey<Block> DRAGON_IMMUNE                 = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "dragon_immune"));
    public static final TagKey<Block> WITHER_IMMUNE                 = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "wither_immune"));
    public static final TagKey<Block> PORTALS                       = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "portals"));
    public static final TagKey<Block> SHULKER_BOXES                 = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "shulker_boxes"));
    public static final TagKey<Block> HOGLIN_REPELLENTS             = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "hoglin_repellents"));
    public static final TagKey<Block> GUARDED_BY_PIGLINS            = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "guarded_by_piglins"));
    public static final TagKey<Block> OCCLUDES_VIBRATION_SIGNALS    = TagKey.of(RegistryKeys.BLOCK, new Identifier(MOD_ID, "occludes_vibration_signals"));
